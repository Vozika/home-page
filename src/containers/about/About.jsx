    ...
    <div className="about__grid" id="about">
      ...
      <div className="about__grid-item--center">
        ...
        >
          ...
          <p>Технологии, которые я использую в веб-разработке: HTML, CSS, SASS, React. Имею большой опыт работы с Joomla, особенно в сфере создания интернет-магазинов. В меньшей степени знаком с Wordpress. Но знаком.</p>
          <p>
            Если вас что-то интересует дополнительно, напишите мне письмо. Адрес
            моей электронной почты <strong>metasoma@yandex.ru</strong>
          </p>
        </motion.div>
        <motion.img
          initial={{ opacity: 0 }}
